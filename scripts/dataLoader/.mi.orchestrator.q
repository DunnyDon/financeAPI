...
.mi.analyseReadWrites:{[batch]
	...
	0N!"Second";
	.mi.tasks:.mi.tasks upsert update taskID:(1+max (0!.mi.tasks)[`taskID]+\:i),batchID:batch,taskSize:toMerge[`colSize],status:`queued,task:`.mi.merge,retries:0,result:(::) from flip enlist[`args]!enlist toMerge;
	0N!"Third";
