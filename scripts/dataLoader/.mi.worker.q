.mi.hdbTmp:`:/home/dunny/yahooAPI/workingDir/hdb/tmp;
.mi.hdbDir:`:/home/dunny/yahooAPI/workingDir/hdb/hdb;
.mi.ihdb:`:/home/dunny/yahooAPI/workingDir/hdb/merge;
.mi.reloadSym:{x};
...
.mi.writeFile:{[x;data]
	...
	written:update t:`taq,symCol:`sym,sortCol:`time,symbolCols:count[written]#enlist[symbolCols]from written;
...
/@TODO change this
.mi.read:{$[any (system"head ",1_string x) like"*TICKER*";.mi.stockRead x;.mi.refDataRead x]};
.mi.refDataRead:{x};
.mi.stockRead:{`sym`sampleRate`symDate`time`open`high`low`close`qty`openint xcol ("SSDTFFFFJJ";enlist csv)0:x};
/@TODO change this
.mi.postRead:{x};
/(`marketTrades;x)};
